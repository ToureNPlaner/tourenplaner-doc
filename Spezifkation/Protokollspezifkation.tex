...
\section{Serverinformation}
	...
	Die Antwort des Servers sollte einen 200 OK Code haben und etwa den untenstehenden Aufbau besitzen.
...
Deshalb werden dem Benutzer Formulare zum Registrieren, Einloggen sowie Bearbeiten seines Accounts gegeben, sowie eine Auflistung der durchgeführten Requests sowie ihrer Kosten.
	...
	Auf Serversweite muss ein neuer Nutzer zunächst durch einen Admin freigeschaltet werden
	bevor er Berechnungen anstoßen kann.
		...
		\begin{lstlisting}
{
	...
	Um die Nutzerdaten zu bearbeiten müssen zunächst die aktuellen Daten vom Server geladen werden so das diese angezeigt und bearbeitet werden können.
		\subsubsection*{Request}
		
		Ein GET-Request an \textit{/userinfo}.
	...
	Nach dem Bearbeiten werden die Daten im gleichen Format wieder an den Server zurückgeschickt. Dieser antwortet mit einem Status 200 OK oder einer Fehlermeldung und dem entsprechenden Fehlercode.
