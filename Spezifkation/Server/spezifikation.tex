...
\sondernachbedingung{
	\item Der Server ist in Betrieb.
	\item Fehlermeldungen wurden soweit möglich verschickt und ins Log gespeichert.}
...
\sonderfall{1a.3}%Letzte Zeile und Nummer
	{%Bezeichnung
	Verbindung zu Client ist abgebrochen wegen serverseitgem Internetausfall
	}{%Sonderfallablauf
...
\sonderfall{2b}%Letzte Zeile und Nummer
	{%Bezeichnung
	Verbindung zu Client ist abgebrochen, aber serverseitig kein Internetausfall
	}{%Sonderfallablauf	
	\item Zähler von abgebrochenen Clientverbindungen um eins hochzählen.}
