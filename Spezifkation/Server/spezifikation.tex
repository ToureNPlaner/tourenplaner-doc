...
%\usecase{}{}%Name und Akteure{}%Ziel{}%Vorbedingungen{}%Nachbedingungen{}%Normalablauf{}%Sondernachbedingungen und Sonderfälle
...
{Der Client möchte die Server-Informationen über die Protokollversion und die verfügbaren Algorithmen erhalten.}%Ziel
{\item Der Server ist in Betrieb.
\item Der Server hat einen Request über \textit{/info} vom Client erhalten.}%Vorbedingungen
{\item Die Server-Informationen wurden dem Client gesendet.}%Nachbedingungen
{\item Der Server sendet die aktuellsten Server-Informationen als Response.}%Normalablauf
{\sondernachbedingung{\item Fehler
		\item Fehler}
\sonderfall[Weiter mit Schritt 2a.1]{1a}%Letzte Zeile und Nummer
	{Internetverbindung ausgefallen}%Bezeichnung
  	{\item Fehler ins Log schreiben
  	\item Erneuter Versuch
  	\item Und nochmal}%Sonderfallablauf
\sonderfall[Schritt 1a.1]{2a}%Letzte Zeile und Nummer
	{Internetverbindung ausgefallen}%Bezeichnung
  	{\item Fehler ins Log schreiben
  	\item Erneuter Versuch
  	\item Und nochmal}%Sonderfallablauf
