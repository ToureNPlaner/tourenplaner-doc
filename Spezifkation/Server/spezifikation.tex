...
\hline
  Akteur & #2\\\hline
  Ziel & #3\\\hline
  Vorbedingungen & \begin{compactitem}[-]#4\end{compactitem}\\\hline
  Normalablauf & \begin{compactenum}[1.]#7\end{compactenum}\\\hline
  Nachbedingungen & \begin{compactitem}[-]#5\end{compactitem}\\\hline
  Sonderfall & #8\\\hline
  %\ifEmpty{#8}{}\else{Sonderfall & #8\\\hline}\fi
  Nachbedingung im Sonderfall& #6\\\hline
  %Makro doesn't work yet for last row
  %\ifEmpty{#6}{}\else{Nachbedingung im Sonderfall& #6\\\hline}\fi
 \end{tabular}
