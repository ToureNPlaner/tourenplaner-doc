...
{Der Client möchte Server-Informationen wie die Protokollversion und die verfügbaren Algorithmen erhalten.}%Ziel
{%Vorbedingungen
...
\usecase{Algorithmusrequest bearbeiten}{Client, Abrechnungs DB}%Name und Akteure
