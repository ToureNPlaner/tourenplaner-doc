...
\usecase{Nutzer registrieren}{Client, Abrechnungs DB}%Name und Akteure
{}%Ziel
{%Vorbedingungen
  \item
}
...
\usecase{Nutzer Anmelden}{Client, Abrechnungs DB}%Name und Akteure
{}%Ziel
{%Vorbedingungen
  \item
}
...
\usecase{Nutzerdaten abfragen}{Client, Abrechnungs DB}%Name und Akteure
{}%Ziel
{%Vorbedingungen
  \item
}
