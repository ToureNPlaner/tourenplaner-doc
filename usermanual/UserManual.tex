...
\begin{lstlisting}[caption=Sample configuration,float]
  {
	 "A_String" = "text",
	 // A Comment
...
{string}
{private only: The URI to the MySQL database. It must be a JAVA JDBC URI. The database name is directly set with this option (e.g. ``/tourenplaner'')}
